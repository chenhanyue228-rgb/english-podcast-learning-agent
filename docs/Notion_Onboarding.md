...
是否安装 Notion 桌面应用不影响设置。尚未使用 Notion 的用户可以从
[Notion 官方网站](https://www.notion.com/) 注册并直接使用网页版；桌面应用
只是可选项，可从
[Notion 官方下载页面](https://www.notion.com/desktop) 获取。Codex 必须等待
用户确认“Notion 已准备好”，再显示开发者后台步骤。
